...
inline fun port(block: com.synclient.grpc.PortKt.Dsl.() -> kotlin.Unit): com.synclient.grpc.Vnarpc.Port =
    com.synclient.grpc.PortKt.Dsl._create(com.synclient.grpc.Vnarpc.Port.newBuilder())
        .apply { block() }._build()
...
object PortKt {
    ...
    class Dsl private constructor(
        ...
        companion object {
            @kotlin.jvm.JvmSynthetic
            @kotlin.PublishedApi
            internal fun _create(builder: com.synclient.grpc.Vnarpc.Port.Builder): Dsl =
                Dsl(builder)
        }
